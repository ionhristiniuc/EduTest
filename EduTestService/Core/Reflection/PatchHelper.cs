...
namespace EduTestService.Core.Reflection
{
    public static class PatchHelper
    {        
        private static readonly ConcurrentDictionary<Type, PropertyInfo[]> TypePropertiesCache =
        ...
        public static void Patch<TPatch, TEntity>(TPatch patch, TEntity entity)
            ...
            where TEntity : class
        {
            PropertyInfo[] properties = TypePropertiesCache.GetOrAdd(patch.GetType(),
